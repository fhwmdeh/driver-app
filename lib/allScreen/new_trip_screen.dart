...
import 'package:driver/assistants/assistants_method.dart';
...
import '../wedgets/fare_amount_collection_dialog.dart';
...
class _NewTripScreenState extends State<NewTripScreen>
{
  ...
  Future<void> drawPolyLineFromOriginToDestination(LatLng originLatLng ,LatLng destinationLatLng ) async {
    ...
    var directionDetailsInfo = await AssistantsMethods.obtainOrginToDistinationDirectionDetails(originLatLng, destinationLatLng);
  ...
  updateDurationTimeAtRealTime() async
  {
    if(isRequestDirectionDetails == false)
    {
      ...
      var directionInformation = await AssistantsMethods.obtainOrginToDistinationDirectionDetails(originLatLng, destinationLatLng);
  ...
  endTripNow() async
  {
    ...
    var tripDirectionDetails = await AssistantsMethods.obtainOrginToDistinationDirectionDetails(
  ...
  saveAssignedDriverDetailsToUserRideRequest()
  {
    ...
    databaseReference.child("car-details").set(onlineDriverData.car_Color.toString() +" "+ onlineDriverData.car_Moder.toString()+"" + onlineDriverData.car_Number.toString());
